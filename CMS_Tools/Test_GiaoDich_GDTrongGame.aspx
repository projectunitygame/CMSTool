<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_GiaoDich_GDTrongGame.aspx.cs" Inherits="CMS_Tools.Test_GiaoDich_GDTrongGame" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="margin-bottom: 10px;">
                            ...
                            <select id="filterColumn" class="form-control">
                            	...
                            	<option value='SendID'>Tài khoản người gửi</option>
                                <option value='SendName'>Tên người gửi</option>
                                <option value='SendAmount'>Số tiền gửi</option>
                                <option value='RecvID'>Tài khoản người nhận</option>
                                <option value='RecvName'>Tên người nhận</option>
                                <option value='RecvAmount'>Số tiền nhận</option>
