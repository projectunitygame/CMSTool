<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_ThongKe.aspx.cs" Inherits="CMS_Tools.Test_ThongKe" %>
...
.af-kpi-box-piece h2{font-size: 22px !important;}
#PageContent_PageID{
	background: #FFF;
    padding: 20px;
}
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageBar" runat="server">
    <div id="PageTitle_PageTitle"><h1 class="page-title">Báo Cáo - Thống Kê <small></small></h1> </div>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><label id="PageBar_lblMenuName">Báo Cáo - Thống Kê</label></span>
            </li>
        </ul>
    ...
    <div id="PageContent_PageID">
        ...
        <div class='row' style='display: block;'>
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    ...
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">NRU Today</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    ...
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">DAU Today</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-2 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    ...
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">PCCU Today</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-2 kpi-box">
            ...
            <div class="col-md-2 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    <div class="col-md-12 af-kpi-box-piece">
                        <h5>PlayGames</h5>
                        <h2>
                            <text id="UserPlay-current" style="transition: background-color 0.8s ease-out 0s, color, opacity;">0</text>
                        </h2>
                    </div>
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">Play Today</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='row' style='display: block;'>
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    <div class="col-md-12 af-kpi-box-piece">
                        <h5>Đại lý chuyển tiền user</h5>
                        <h2>
                            <text id="txtAgencyBankUser" style="transition: background-color 0.8s ease-out 0s, color, opacity;">0</text>
                        </h2>
                    </div>
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">Tổng tiền</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    <div class="col-md-12 af-kpi-box-piece">
                        <h5>User chuyển tiền đại lý</h5>
                        <h2>
                            <text id="txtUserBankAgency" style="transition: background-color 0.8s ease-out 0s, color, opacity;">0</text>
                        </h2>
                    </div>
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">Tổng tiền</h5>
            ...
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    <div class="col-md-12 af-kpi-box-piece">
                        <h5>Đại lý chuyển tiền user trong ngày</h5>
                        <h2>
                            <text id="txtAgencyBankUserToDay" style="transition: background-color 0.8s ease-out 0s, color, opacity;">0</text>
                        </h2>
                    </div>
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">Tổng tiền</h5>
            ...
            <div class="col-md-3 kpi-box">
                <div class='kpi-border af-kpi-box-pieces-container'>
                    <div class="col-md-12 af-kpi-box-piece">
                        <h5>User chuyển tiền đại lý trong ngày</h5>
                        <h2>
                            <text id="txtUserBankAgencyToDay" style="transition: background-color 0.8s ease-out 0s, color, opacity;">0</text>
                        </h2>
                    </div>
                    <div class='clearfix'>
                        <h5 class="af-kpi-box-footer">Tổng tiền</h5>
        ...
        <div class='row'>
            <!-------------Thống kê user đổi tiền--------------->
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="portlet box blue ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bar-chart"></i> User Transaction Report
                        </div>
                        <div class="tools">
            ...
            <!-------------End thống kê user đổi tiền--------------->
    	    <!------ DAU report------>
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="portlet box blue ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bar-chart"></i> DAU Report
                        </div>
                        <div class="tools">
                            <a href="javascript:;" class="collapse" data-original-title="" title=""></a>
                        </div>
            ...
            <!--------- end ccu 24h report------------>
            <!--------- User playgame report----------->
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="portlet box blue ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bar-chart"></i> User playgame Report
                        </div>
                        <div class="tools">
                            <a href="javascript:;" class="collapse" data-original-title="" title=""></a>
                        </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageJSAdd" runat="server">
    ...
    <script type="text/javascript">
            ...
            var NAU_Table = function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 0) {
                                ...
                                $('#dau-android').html(dataReport[countRow - 1][1])//android
                                $('#dau-ios').html(dataReport[countRow - 1][2])//ios
                                $('#dau-web').html(dataReport[countRow - 1][3])//web
                ...
                UserPlay_Table = function () {
                    ...
                    $.ajax({
                        ...
                        data: {
                            type: 13,
                            mid: 57, //Users playgame
                            p: ""
                        },
                        dataType: 'json',
                        success: function (data) {
                            if (data.data.length > 0) {
                                $('#UserPlay-current').html(data.data[0][0]);
                            }
                            else {
                                $('#UserPlay-current').html("0");
                            }
                        },
                        complete: function () {
                            //$(".divLoading").fadeOut(500);
                ...
                UserPlaygame_Table = function () {
                    var table_UserPlay = $('#tbl_datatable4');
                    loadTable4();
                    function loadTable4() {
                        //$('.divLoading').fadeIn();
                        $.ajax({
                                ...
                                if (data.status == 0) {
                                    ...
                                    for (var i = 0; i < countRow; i++) {
                                        ...
                                        chartData.push({
                                            "date": data.data[i][0],
                                            "user": data.data[i][1],
                                            "chartName": "User playgames"
                                        });
                                    }
                                    //console.log(dataReport);
                                    var colHiden = [];
                                    oTable4 = table_UserPlay.dataTable({
                                        "data": dataReport,
                                        "lengthMenu": [
                                            [10, 50, 100, 500, -1],
                                            [10, 50, 100, 500, "All"]
                                    ...
                                    loadUserPlaygame_Chart(chartData, 'chartdiv4');
                                }
                                else {
                                    bootbox.alert({
                                        message: data.msg,
                ...
                UserTransAction_Table = function () {
                    var table_TransUser = $('#tbl_datatable5');
                    loadTable5();
                    function loadTable5() {
                        if (_dateStart == null)
                            _dateStart = moment().subtract('month', 1).format('YYYY/MM/DD');
                            ...
                            success: function (data) {
                                ...
                                if (data.status == 0) {
                                    ...
                                    if (colFilter5 == null) {
                                        ...
                                        var strHtmlColName = "";
                                        _dataColumn5.splice(_dataColumn5.length - 1, 1);
                                    ...
                                    for (var i = 0; i < countRow; i++) {
                                        ...
                                        chartData.push({
                                            "date": data.data[i][1],
                                            "money_day": data.data[i][0],
                                            "chartName": "User playgames"
                                        });
                                    }
                                    //console.log(dataReport);
                                    var totalAgencyBankUser = 0;
                                    var totalUserBankAgency = 0;
                                    $.each(data.data, function (i, obj) {
                                        var strData = '';
                                        switch (obj[2]) {
                                            case "1":
                                                strData = "Đại lý chuyển tiền user";
                                                totalAgencyBankUser += parseInt(replaceAll(obj[0], ',', '')); 
                                                break;
                                            case "3":
                                                strData = "User chuyển tiền đại lý"
                                                totalUserBankAgency += parseInt(replaceAll(obj[0], ',', ''));
                                                break;
                                            default:
                                                break;
                                        }
                                    ...
                                    $('#txtAgencyBankUser').text(formatMoney(totalAgencyBankUser));
                                    $('#txtUserBankAgency').text(formatMoney(totalUserBankAgency));
                                        ...
                                        success: function (data) {
                                            ...
                                            if (data.status == 0) {
                                                if (data.data.length > 0) {
                                                    $.each(data.data, function (i, obj) {
                                                        if (obj[2] == "1") {
                                                            $('#txtAgencyBankUserToDay').text(obj[0]);
                                                        }
                                                        else if (obj[2] == "3") {
                                                            $('#txtUserBankAgencyToDay').text(obj[0]);
                                                        }
                                    ...
                                    var colHiden = [];
                                    oTable5 = table_TransUser.dataTable({
                                        "data": dataReport,
                                        "lengthMenu": [
                                            [10, 50, 100, 500, -1],
                                            [10, 50, 100, 500, "All"]
                                    ...
                                    var tableWrapper = $("#tbl_datatable5_wrapper");
                                    jQuery('#tbl_datatable5_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table search input
                                    jQuery('#tbl_datatable5_wrapper .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
                                    jQuery('#tbl_datatable5_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
                                    loadUserBank_Chart(chartData, 'chartdiv5');
        ...
        function loadUserPlaygame_Chart(dataChart, ChartID) {
            am4core.ready(function () {
                am4core.useTheme(am4themes_animated);
                var chart = am4core.create(ChartID, am4charts.XYChart);
                chart.data = dataChart;
                ...
                // Create axes
                var distanceAxis = chart.yAxes.push(new am4charts.ValueAxis());
                distanceAxis.title.text = "users";
                distanceAxis.renderer.grid.template.disabled = true;
                // Create series
                var distanceSeries = chart.series.push(new am4charts.ColumnSeries());
                distanceSeries.dataFields.valueY = "user";
                distanceSeries.dataFields.dateX = "date";
                distanceSeries.yAxis = distanceAxis;
                distanceSeries.tooltipText = "Users: {valueY}";
                distanceSeries.name = "UserPlay";
                distanceSeries.columns.template.fillOpacity = 0.7;
                distanceSeries.columns.template.propertyFields.strokeDasharray = "dashLength";
                distanceSeries.columns.template.propertyFields.fillOpacity = "alpha";
        ...
        function loadUserBank_Chart(dataChart, ChartID) {
            am4core.ready(function () {
                am4core.useTheme(am4themes_animated);
                var chart = am4core.create(ChartID, am4charts.XYChart);
                chart.data = dataChart;
                ...
                // Create series
                var distanceSeries = chart.series.push(new am4charts.ColumnSeries());
                distanceSeries.dataFields.valueY = "money_day";
                distanceSeries.dataFields.dateX = "date";
                distanceSeries.yAxis = distanceAxis;
                distanceSeries.tooltipText = "Users: {valueY}";
                distanceSeries.name = "UserPlay";
