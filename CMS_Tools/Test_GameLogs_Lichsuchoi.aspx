<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_GameLogs_LichSuChoi.aspx.cs" Inherits="CMS_Tools.Test_GameLogs_Lichsuchoi" %>
            ...
            <div class="portlet box blue ">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="margin-bottom: 10px;">
                        	<label class="control-label label-balance">Chọn game</label>
                            <select id="selectGameID" class="form-control">
                                <option value='0'>Tất cả</option>
                                <option value='1'>Kungfu Panda</option>
                            	<option value='2'>Thần tài</option>
                                <option value='3'>Tam quốc</option>
                                <option value='4'>MiniPoker</option>
                                <option value='5'>MiniSlot</option>
                                ...
                                <option value='12'>Xóc Dĩa</option>
                        ...
                        <div class="col-md-3" style="margin-bottom: 10px;">
                            ...
                            <select id="filterColumn" class="form-control">
                            	...
                            	<option value='Username'>TK Đăng nhập</option>
                                <option value='DisplayName'>Tên trong game</option>
                            </select>
                        </div>
                        <div class="col-md-3" style="margin-bottom: 10px;">
