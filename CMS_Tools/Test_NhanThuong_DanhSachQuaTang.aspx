<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_NhanThuong_DanhSachQuaTang.aspx.cs" Inherits="CMS_Tools.Test_GameDT_LichSuNoHu" %>
...
#tbl_datatable tbody tr:nth-child(1)>td:nth-child(7){
            width:115px;
        }
a.delete{
    display:none;
...
<script type="text/javascript">
    ...
    function saveRow(oTable, nRow) {
        ...
        $.ajax({
            type: "POST",
            url: "Apis/Menu.ashx",
            data: { type: type, menuID: AppManage.getURLParameter("m"), data: JSON.stringify(data) },
            success: function (data) {
                if (data.status == 0) {
                    TableEditable.init();
                }
