var ComponentsNoUiSliders = function () {
    var e = function () {
        ...
        t = function () {
            for (var e = document.getElementById("demo4_select"), n = -20; n <= 40; n++) {
        ...
        d = function () {
            var e = document.getElementById("setting_nhietdo");
            noUiSlider.create(e, {
                start: [20, 60],
                step: 1,
                connect: !0,
            ...
            for (var n = e.getElementsByClassName("noUi-handle"), t = [], i = 0; i < n.length; i++)
                ...
                , t[1].innerHTML = "<strong>High: </strong><span></span>"
                , t[1] = t[1].getElementsByTagName("span")[0]
                , t[0].className += "noUi-tooltip"
                , t[0].innerHTML = "<strong>Low: </strong><span></span>"
                , t[0] = t[0].getElementsByTagName("span")[0]
                    , e.noUiSlider.on("update", function (e, n) {
                    t[n].innerHTML = parseInt(e[n])
                });
        },
        e = function () {
            var e = document.getElementById("setting_doam");
            noUiSlider.create(e, {
                start: [30, 80],
                step: 1,
                connect: !0,
            ...
            for (var n = e.getElementsByClassName("noUi-handle"), t = [], i = 0; i < n.length; i++) t[i] = document.createElement("div"), n[i].appendChild(t[i]);
            t[1].className += "noUi-tooltip", t[1].innerHTML = "<strong>High: </strong><span></span>", t[1] = t[1].getElementsByTagName("span")[0], t[0].className += "noUi-tooltip", t[0].innerHTML = "<strong>Low: </strong><span></span>", t[0] = t[0].getElementsByTagName("span")[0], e.noUiSlider.on("update", function (e, n) {
                t[n].innerHTML = parseInt(e[n])
            })
        };
    return {
